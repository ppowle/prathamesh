...
<input type="text" class="form-control" name="uname" placeholder="Enter User id" pattern=".{6,15}" title="Username should not be less than 6 char and more than 15 char" required/> 
<label for="password">Password:</label>  
<input type="password" class="form-control" name="password" placeholder="Enter Password" pattern=".{6,15}" title="Password should not be less than 6 char and more than 15 char" required/>  
<label for="name">Name:</label>  
<input type="text" class="form-control" name="name" placeholder="Enter Name" pattern="[A-Za-z]{6,15}" title="Name should not be alphanumeric and should be between 6 to 15 char" required/> 
...
<input type="text" class="form-control" name="pinc" placeholder="Enter ZIP Code" pattern="\d{6}" title="Invalid ZIP format" required/> 
<label for="mail">Email Id:</label>
<input type="text" class="form-control" name="mail" size="50" placeholder="Enter Email Id" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required/>
<br>  
