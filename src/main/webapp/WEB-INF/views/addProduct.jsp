...
<center><h2>ADD Product</h2></center>
	...
	<form:form action="addProduct" method="post" enctype="multipart/form-data">
		<left>
			...
			<tr>
				<td>Enter Product Class:</td>
				<td><input type="text" name="p_class"></td></tr>
		<tr>
				<td>Enter Product Engine Type:</td>
				<td><input type="text" name="p_engine"></td></tr>
	<tr>
			
				<td>Enter Product Type:</td>
				<td><input type="text" name="p_type"></td></tr>
	<tr>
				<td>Enter Product Price:</td>
				<td><input type="text" name="p_price"></td></tr>
			<tr>
				<td>Enter Product Owner:</td>
				<td><input type="text" name="p_owner"></td></tr>
				
				<tr>
				<td>Enter Product Image:</td>
		      <td><input type="file" name="ipath"></td></tr>
